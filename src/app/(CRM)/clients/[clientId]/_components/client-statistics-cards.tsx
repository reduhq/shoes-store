...
import { AlertTriangle, CalendarDays, CreditCard, DollarSign, TrendingUp } from 'lucide-react'
...
const ClientStatisticsCards = () => {
  ...
  const getPaymentUrgency = (days: number) => {
    if (days <= 0) return { color: "text-red-700", bg: "bg-red-50", border: "border-red-200", status: "Vencido" }
    if (days <= 3) return { color: "text-red-700", bg: "bg-red-50", border: "border-red-200", status: "Urgente" }
    if (days <= 7) return { color: "text-amber-700", bg: "bg-amber-50", border: "border-amber-200", status: "Próximo" }
    return { color: "text-green-700", bg: "bg-green-50", border: "border-green-200", status: "A Tiempo" }
  }
    ...
    <div className="md:col-span-6 lg:col-span-6 xl:col-span-6 2xl:col-span-6 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 2xl:grid-cols-1 gap-3 sm:gap-4 md:gap-4 lg:gap-5 xl:gap-6">
            <Card className="shadow-lg border-0 bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-xl transition-all duration-300 w-full">
              ...
              <CardContent>
                ...
                <p className="text-xs text-green-600 mt-1">{formatCurrency(10000)} pagado</p>
            ...
            <Card className="shadow-lg border-0 bg-gradient-to-br from-purple-50 to-violet-50 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                <Badge variant="outline" className="bg-purple-100 text-purple-700 border-purple-200 mt-1 text-xs">
            ...
            <Card className="shadow-lg border-0 bg-gradient-to-br from-teal-50 to-cyan-50 hover:shadow-xl transition-all duration-300">
              ...
              <CardContent>
                ...
                <Badge variant="outline" className="bg-teal-100 text-teal-700 border-teal-200 mt-1 text-xs">
                  {2} completados
